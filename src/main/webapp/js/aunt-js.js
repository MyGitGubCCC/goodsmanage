$(function (){
    ...
    $("#findbtn").click(function () {
        //获取输入框的内容
        var auntname = $("input[name='auntname']").val();
        var auntno = $("input[name='auntno']").val();
        var auntphoneno = $("input[name='auntphoneno']").val();
    ...
    $("#delbtn").click(function(){
        $("#auntname").textbox('setValue','');
        $("#auntno").textbox('setValue','');
        $("#auntphoneno").textbox('setValue','');
