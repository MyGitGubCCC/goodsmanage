...
<div data-toggle="topjui-layout" data-options="id:'index_layout',fit:true">
    <div id="north" class="banner" data-options="region:'north',border:false,split:false"
        ...
        <table style="float:left;border-spacing:0px;">
            <tr>
                <td class="webname">
                    <span class="fa fa-envira" style="font-size:26px; padding-right:8px;"></span>贵重物品管理系统
                </td>
    ...
    <div data-options="region:'south',border:true"
        ...
        <span style="float:left;padding-left:5px;width:30%;text-align: left;">当前用户：${name}+${role}+${number}<input type="hidden" readonly="readonly" required="true" name="privilege" id="privilege" value="${role}"/></span>
        <span style="padding-right:5px;width:40%">
            版权所有 © 2018-2018
            <a href="#" target="_blank">曹成成毕业设计专用</a>
        </span>
...
<form id="pwdDialog" data-options="title: '修改密码',
    ...
    <table class="editTable">
        <tr>
            ...
            <td><input type="text" id="username" name="username" value="${number}"></td>
        </tr>
        <tr>
