            ...
            <div style="padding:10px 60px 20px 60px">
                <form id="ff" class="easyui-form" method="post" >
                    <table cellpadding="5">
                        ...
                        <tr>
                            <td>姓名:</td>
                            <td><input class="easyui-textbox" type="text" style="width:147px;" name="sname" data-options="required:true,readonly:true"></td>
                        </tr>
                        <tr>
                            <td>学号:</td>
                            <td><input class="easyui-textbox" type="text" style="width:147px;" name="sno" data-options="required:true,readonly:true"></td>
                        </tr>
                        <tr>
                            <td><p style="color: #6293BB;font-weight:bold">校园卡号:</p></td>
                            <td><input class="easyui-numberbox" type="text" style="width:147px;" name="cardno" data-options="required:true"/></td>
                        </tr>
                        <tr>
                            <td>性别:</td>
                            <td><input class="easyui-textbox" type="text" style="width:147px;" name="ssex" data-options="required:true,readonly:true"></td>
                        </tr>
                        <tr>
                            <td>电话:</td>
                            <td><input class="easyui-textbox" type="text" style="width:147px;" name="sphoneno" data-options="required:true,readonly:true"></td>
                        </tr>
                        <tr>
                            <td>QQ:</td>
                            <td><input class="easyui-textbox" type="text" style="width:147px;" name="qq" data-options="required:true,readonly:true"></td>
                        </tr>
                        <tr>
                            <td>班级:</td>
                        ...
                        <tr>
                            ...
                            <td><select class="easyui-combobox" data-options="editable:false,required:true" name="bedno" style="width:147px;">
                        ...
                        <tr>
                            <td>家庭住址:</td>
                            <td><input class="easyui-textbox" name="homeadress" data-options="multiline:true,required:true,readonly:true" style="width:147px;height:60px"></td>
                        </tr>
                    </table>
                </form>
